  ...
  return (
    <div
      style={{
        ...
        padding: '20px',
        background:
          'radial-gradient(circle at 15% 15%, rgba(159,227,181,0.22), transparent 30%), radial-gradient(circle at 88% 18%, rgba(223,248,231,0.2), transparent 24%), linear-gradient(160deg, #f8fffb 0%, #eff9f2 100%)',
      }}
    >
      <div
        style={{
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: 22 }}>
          ...
          <h2 style={{ fontFamily: 'Outfit, sans-serif', fontSize: 30, fontWeight: 800, color: '#173525', margin: 0 }}>Farmora</h2>
        ...
        <div
          style={{
            ...
            gap: 8,
            marginBottom: 18,
            background: 'rgba(159,227,181,0.08)',
            borderRadius: 12,
            padding: 6,
        ...
        <div style={{ display: 'flex', alignItems: 'center', margin: '16px 0' }}>
          ...
          <span style={{ margin: '0 10px', color: '#4d705d', fontSize: 11, fontWeight: 700 }}>or continue with</span>
          <div style={{ flex: 1, height: 1, background: 'rgba(159,227,181,0.26)' }} />
        </div>
