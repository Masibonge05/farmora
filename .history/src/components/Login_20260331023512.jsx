  ...
  return (
    <div
      style={{
        ...
        padding: '20px',
        background:
          'radial-gradient(circle at 15% 15%, rgba(159,227,181,0.22), transparent 30%), radial-gradient(circle at 88% 18%, rgba(223,248,231,0.18), transparent 24%), linear-gradient(160deg, #0f1a14 0%, #132118 100%)',
      }}
    >
      <div
        style={{
          width: '100%',
          maxWidth: 430,
          background: 'linear-gradient(160deg, rgba(18,31,23,0.9), rgba(14,24,18,0.95))',
          border: '1px solid rgba(159,227,181,0.28)',
          borderRadius: 16,
          padding: '28px 24px',
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: 22 }}>
          ...
          <h2 style={{ fontFamily: 'Outfit, sans-serif', fontSize: 30, fontWeight: 800, color: '#f7fff9', margin: 0 }}>Farmora</h2>
          <p style={{ color: '#b7e7c5', fontSize: 12, fontWeight: 700, letterSpacing: '0.08em', margin: '6px 0 0', textTransform: 'uppercase' }}>
        ...
        <div
          style={{
            ...
            borderRadius: 12,
            padding: 6,
            border: '1px solid rgba(159,227,181,0.22)',
          }}
        >
          <button
            style={{
              ...
              color: mode === 'signin' ? '#143126' : '#b7cdbd',
              background: mode === 'signin' ? 'linear-gradient(135deg, #9fe3b5, #dff8e7)' : 'transparent',
            }}
          ...
          <button
            style={{
              ...
              color: mode === 'signup' ? '#143126' : '#b7cdbd',
              background: mode === 'signup' ? 'linear-gradient(135deg, #9fe3b5, #dff8e7)' : 'transparent',
            }}
        ...
        <form style={{ display: 'flex', flexDirection: 'column', gap: 10 }} onSubmit={handleSubmit}>
          ...
          <button
            ...
            style={{
              ...
              borderRadius: 10,
              border: 'none',
              background: 'linear-gradient(135deg, #9fe3b5, #dff8e7)',
              color: '#123122',
              fontWeight: 800,
              fontSize: 14,
              cursor: 'pointer',
        ...
        <div style={{ display: 'flex', alignItems: 'center', margin: '16px 0' }}>
          <div style={{ flex: 1, height: 1, background: 'rgba(159,227,181,0.26)' }} />
          <span style={{ margin: '0 10px', color: '#b7cdbd', fontSize: 11, fontWeight: 700 }}>or continue with</span>
          <div style={{ flex: 1, height: 1, background: 'rgba(159,227,181,0.26)' }} />
        </div>
        ...
        {error && <div style={{ marginTop: 12, color: '#f1b1b1', textAlign: 'center', fontSize: 12, fontWeight: 700 }}>{error}</div>}
      </div>
    </div>
  )
}
