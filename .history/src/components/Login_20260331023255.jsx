  ...
  return (
    <div
      style={{
        ...
        padding: '20px',
        background:
          'radial-gradient(circle at 15% 15%, rgba(199,165,106,0.15), transparent 30%), radial-gradient(circle at 88% 18%, rgba(144,167,216,0.12), transparent 24%), linear-gradient(160deg, #0f1117 0%, #141824 100%)',
      }}
    >
      <div
        style={{
          width: '100%',
          maxWidth: 430,
          background: 'linear-gradient(160deg, rgba(19,24,35,0.92), rgba(14,18,27,0.95))',
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: 22 }}>
          ...
          <h2 style={{ fontFamily: 'Outfit, sans-serif', fontSize: 30, fontWeight: 800, color: '#f5f2ea', margin: 0 }}>Farmora</h2>
          <p style={{ color: '#b9a27a', fontSize: 12, fontWeight: 700, letterSpacing: '0.08em', margin: '6px 0 0', textTransform: 'uppercase' }}>
        ...
        >
          <button
            style={{
              ...
              color: mode === 'signin' ? '#f6eedf' : '#9ca2b2',
              background: mode === 'signin' ? 'linear-gradient(135deg, #7a6540, #c7a56a)' : 'transparent',
            }}
          ...
          <button
            style={{
              ...
              color: mode === 'signup' ? '#f6eedf' : '#9ca2b2',
              background: mode === 'signup' ? 'linear-gradient(135deg, #7a6540, #c7a56a)' : 'transparent',
            }}
        ...
        <form style={{ display: 'flex', flexDirection: 'column', gap: 10 }} onSubmit={handleSubmit}>
          ...
          <button
            ...
            style={{
              ...
              borderRadius: 10,
              border: 'none',
              background: 'linear-gradient(135deg, #7a6540, #c7a56a)',
              color: '#17120a',
              fontWeight: 800,
              fontSize: 14,
              cursor: 'pointer',
        ...
        <div style={{ display: 'flex', alignItems: 'center', margin: '16px 0' }}>
          <div style={{ flex: 1, height: 1, background: 'rgba(199,165,106,0.2)' }} />
          <span style={{ margin: '0 10px', color: '#9ca2b2', fontSize: 11, fontWeight: 700 }}>or continue with</span>
          <div style={{ flex: 1, height: 1, background: 'rgba(199,165,106,0.2)' }} />
        </div>
        ...
        {error && <div style={{ marginTop: 12, color: '#d89a8e', textAlign: 'center', fontSize: 12, fontWeight: 700 }}>{error}</div>}
      </div>
    </div>
  )
}
