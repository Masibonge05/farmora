  ...
  return (
    <div
      style={{
        ...
        padding: '20px',
        background:
          'radial-gradient(circle at 15% 15%, rgba(225,197,138,0.22), transparent 30%), radial-gradient(circle at 88% 18%, rgba(247,236,210,0.2), transparent 24%), linear-gradient(160deg, #f8f3ea 0%, #efe5d6 100%)',
      }}
    >
      <div
        style={{
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: 22 }}>
          <span style={{ fontSize: 22, marginBottom: 8, color: '#8d6b33', fontWeight: 800, border: '1px solid #c9a766', borderRadius: 999, padding: '4px 10px' }}>F</span>
