    ...
    <>
      ...
      <aside
        ...
        style={{
          ...
          boxShadow: isMobile ? '10px 0 24px rgba(0,0,0,0.1)' : '0 0 0 1px rgba(226,232,240,0.45)',
        }}
      >
      <div style={{ padding: '24px 18px 18px', borderBottom: '1px solid var(--panel-border)' }}>
      ...
      <div style={{ padding: '12px 10px 18px', borderTop: '1px solid var(--panel-border)' }}>
        ...
        <div className="nav-item" style={{ color: '#1f2937' }}>
