    ...
    <>
      ...
      <aside
        style={{
          ...
          minHeight: '100vh',
          flexShrink: 0,
          background: 'linear-gradient(180deg, rgba(17,22,33,0.97) 0%, rgba(13,17,26,0.98) 100%)',
          borderRight: '1px solid rgba(199,165,106,0.2)',
          display: 'flex',
      ...
      >
      <div style={{ padding: '22px 18px 18px', borderBottom: '1px solid rgba(199,165,106,0.16)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          <div
            style={{
              ...
              height: 34,
              borderRadius: 9,
              background: 'linear-gradient(145deg, #c7a56a, #8f7548)',
              display: 'flex',
              alignItems: 'center',
              justifyContent: 'center',
              fontSize: 16,
              boxShadow: '0 8px 18px rgba(199,165,106,0.28)',
            }}
          >
            🌿
          </div>
      ...
      <div style={{ padding: '14px 14px 10px' }}>
        ...
        >
          ...
          >
            Thabo&apos;s Farm
            <span style={{ fontSize: 10, color: '#d6ba89' }}>▼</span>
          </div>
          <div style={{ fontSize: 11, color: '#a7adbc', marginTop: 2 }}>Limpopo, RSA · 10 ha</div>
        </div>
      </div>
      ...
      <div style={{ padding: '12px 10px 16px', borderTop: '1px solid rgba(199,165,106,0.16)' }}>
        ...
        <div
          style={{
            marginTop: 16,
            padding: '14px',
            background: 'rgba(144,167,216,0.1)',
            borderRadius: 12,
            border: '1px solid rgba(144,167,216,0.3)',
          }}
        >
          <div
            style={{
          ...
          <button
            ...
            style={{
              ...
              justifyContent: 'center',
              gap: 6,
              boxShadow: '0 8px 20px rgba(199,165,106,0.28)',
              transition: 'all 0.2s',
            }}
          >
            💬 Ask Farmora AI
