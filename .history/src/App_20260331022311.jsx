    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: 'transparent' }}>
      <div
        style={{
          ...
          zIndex: 0,
          background:
            'radial-gradient(ellipse 58% 40% at 70% 18%, rgba(45,106,45,0.08) 0%, transparent 72%)',
        }}
      />
      ...
      <main style={{ flex: 1, overflowY: 'auto', position: 'relative', zIndex: 1 }}>
        <div
          style={{
            ...
            top: 0,
            zIndex: 50,
            background: 'rgba(9,19,9,0.82)',
            backdropFilter: 'blur(16px)',
            borderBottom: '1px solid rgba(126,200,126,0.14)',
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, minWidth: 0 }}>
            ...
            <div style={{ fontSize: 13, color: '#99ac99', letterSpacing: '0.01em' }}>
            <span style={{ color: '#dff0df', fontWeight: 600 }}>Thabo Farm</span> · Gauteng, South Africa
            </div>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? 10 : 16, marginLeft: 'auto' }}>
            ...
            {!isMobile && <div style={{ fontSize: 13, color: '#99ac99' }}>⛅ 24°C · Limpopo</div>}
            <div style={{ 
              width: 32, height: 32, borderRadius: '50%',
              background: 'linear-gradient(140deg, #7ec87e, #2d6a2d)',
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              fontSize: 12, fontWeight: 800, color: '#071007', cursor: 'pointer',
              boxShadow: '0 4px 18px rgba(126,200,126,0.3)'
            }}>T</div>
          </div>
        </div>
