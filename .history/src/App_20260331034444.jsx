    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: 'var(--bg-1)' }}>
      <div
        style={{
          ...
          backgroundImage:
            'linear-gradient(rgba(143,216,177,0.06) 1px, transparent 1px), linear-gradient(90deg, rgba(143,216,177,0.06) 1px, transparent 1px)',
          backgroundSize: '42px 42px',
          maskImage: 'radial-gradient(circle at 50% 10%, rgba(0,0,0,0.5), rgba(0,0,0,1) 60%)',
        }}
      />
