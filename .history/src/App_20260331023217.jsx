    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: 'transparent' }}>
      <div
        style={{
          ...
          zIndex: 0,
          background:
            'radial-gradient(ellipse 58% 40% at 70% 18%, rgba(199,165,106,0.1) 0%, transparent 72%)',
        }}
      />
      ...
      <main style={{ flex: 1, overflowY: 'auto', position: 'relative', zIndex: 1 }}>
        <div
          style={{
            ...
            borderBottom: '1px solid rgba(199,165,106,0.2)',
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, minWidth: 0 }}>
            {isMobile && (
              <button
                ...
                style={{
                  border: '1px solid rgba(199,165,106,0.35)',
            ...
            <div style={{ fontSize: 13, color: '#a8adbb', letterSpacing: '0.01em' }}>
            <span style={{ color: '#f5f2ea', fontWeight: 600 }}>Thabo Farm</span> · Gauteng, South Africa
            </div>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? 10 : 16, marginLeft: 'auto' }}>
            ...
            {!isMobile && <div style={{ fontSize: 13, color: '#a8adbb' }}>⛅ 24°C · Limpopo</div>}
            <div style={{ 
              width: 32, height: 32, borderRadius: '50%',
              background: 'linear-gradient(140deg, #c7a56a, #8f7548)',
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              fontSize: 12, fontWeight: 800, color: '#18120a', cursor: 'pointer',
              boxShadow: '0 4px 18px rgba(199,165,106,0.35)'
            }}>T</div>
          </div>
        </div>
