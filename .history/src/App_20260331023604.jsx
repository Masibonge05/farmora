    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: 'transparent' }}>
      <div
        style={{
          ...
          zIndex: 0,
          background:
            'radial-gradient(ellipse 58% 40% at 70% 18%, rgba(159,227,181,0.2) 0%, transparent 72%)',
        }}
      />
      ...
      <main style={{ flex: 1, overflowY: 'auto', position: 'relative', zIndex: 1 }}>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, minWidth: 0 }}>
            {isMobile && (
              <button
                ...
                style={{
                  ...
                  background: 'rgba(159,227,181,0.18)',
                  color: '#1a5539',
                  borderRadius: 8,
                  width: 34,
                  height: 34,
            ...
            <div style={{ fontSize: 13, color: '#4d705d', letterSpacing: '0.01em' }}>
            <span style={{ color: '#173525', fontWeight: 600 }}>Thabo Farm</span> · Gauteng, South Africa
            </div>
          </div>
