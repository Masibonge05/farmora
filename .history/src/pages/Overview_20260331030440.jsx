  ...
  return (
    <div
      ...
      style={{
        ...
        background: 'linear-gradient(135deg, rgba(184,146,74,0.1), rgba(217,191,138,0.04))',
    ...
    <div style={{ padding: isMobile ? '18px 14px' : '28px 32px', maxWidth: 1200 }}>
      <div style={{ marginBottom: 28 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 6 }}>
          <span style={{ fontSize: 12, fontWeight: 800, color: '#8d6b33', border: '1px solid #c9a766', borderRadius: 999, padding: '2px 8px' }}>OV</span>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : isTablet ? 'repeat(2, 1fr)' : 'repeat(4, 1fr)', gap: 16, marginBottom: 24 }}>
        <MetricCard label="Total Area" value={totalHectares.toFixed(1)} unit="ha" sub="4 active fields" icon="A" color="#b8924a" delay={0} />
        <MetricCard label="Healthy Fields" value={healthyCount} unit={`/${farmFields.length}`} sub="2 need attention" icon="H" color="#b8924a" delay={50} />
        <MetricCard label="Avg Moisture" value="53" unit="%" sub="Field D critical" icon="M" color="#3b82f6" delay={100} />
