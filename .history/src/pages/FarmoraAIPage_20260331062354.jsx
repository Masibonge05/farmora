...
function CapabilityCard({ icon, title, detail }) {
  return (
    <div
      style={{
        display: "grid",
        ...
        background: "linear-gradient(180deg, #f8fcfa 0%, #f0f8f3 100%)",
        boxShadow: "0 8px 18px rgba(16, 77, 36, 0.06)",
        minWidth: 220,
      }}
    >
      <div
        style={{
          ...
          borderRadius: 9,
          background: "#ffffff",
          boxShadow: "inset 0 0 0 1px #d7e8de",
