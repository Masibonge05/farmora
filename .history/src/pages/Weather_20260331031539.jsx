...
const statusColors = { ok: '#3f6f5b', warn: '#475569', alert: '#c85820' };
  ...
  return (
    <div style={{ padding: isMobile ? '18px 14px' : '28px 32px', maxWidth: 1200 }}>
      ...
      <div style={{
        ...
        <div style={{ position: 'absolute', bottom: -60, left: 40, width: 250, height: 250, borderRadius: '50%', background: 'rgba(100,116,139,0.05)', pointerEvents: 'none' }} />
        <div>
          ...
          <div style={{ fontSize: 13, color: '#64748b', fontWeight: 600 }}>Gauteng, South Africa - Monday 30 March 2026</div>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(8, minmax(78px, 1fr))', gap: 8, overflowX: 'auto' }}>
          {hourlyForecast.map((h, i) => (
            <div key={h.time} style={{
              ...
              border: `1px solid ${i === 3 ? 'rgba(100,116,139,0.3)' : 'transparent'}`,
            }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: isTablet ? '1fr' : '1fr 1fr', gap: 20 }}>
        <div className="card" style={{ padding: '20px 24px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 4, overflowX: isMobile ? 'auto' : 'visible' }}>
            {extendedForecast.map((day, i) => {
              const rainColor = day.rain > 60 ? '#c85820' : day.rain > 30 ? '#64748b' : '#80c0f0';
              return (
                <div key={day.day} style={{
                  ...
                  <div style={{ textAlign: 'right', fontSize: 12 }}>
                    ...
                    <span style={{ color: '#334155' }}> / {day.low}</span>
                  </div>
        ...
        <div className="card" style={{ padding: '20px 24px' }}>
          ...
          <div style={{
            ...
            background: 'rgba(58,140,200,0.14)', border: '1px solid rgba(58,140,200,0.42)',
            display: 'flex', gap: 10, alignItems: 'center',
          }}>
            <span style={{ fontSize: 20 }}>RN</span>
            <div>
              <div style={{ fontSize: 12, fontWeight: 800, color: '#1e3a5f' }}>Heavy rain forecast Wed-Thu (70-85%)</div>
              <div style={{ fontSize: 11, color: '#334155', marginTop: 2, fontWeight: 600 }}>Adjust irrigation schedules for all fields</div>
            </div>
          </div>
            ...
            {irrigationAdvisory.map(field => {
              ...
              return (
                <div key={field.field} style={{
                  ...
                  background: `${col}12`, border: `1px solid ${col}45`,
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 11, color: '#334155', lineHeight: 1.45, fontWeight: 500 }}>{field.note}</div>
                  </div>
                  <div style={{
                    padding: '4px 10px', borderRadius: 20, fontSize: 10, fontWeight: 700,
                    background: `${col}24`, color: col, whiteSpace: 'nowrap', border: `1px solid ${col}55`,
                  }}>{field.today}</div>
                </div>
              );
            })}
