        ...
        <div className="card" style={{ padding: '20px 24px' }}>
          ...
          <ResponsiveContainer width="100%" height={260}>
            <RadarChart data={radarData}>
              ...
              <Tooltip contentStyle={{ background: '#ffffff', border: '1px solid rgba(100,116,139,0.3)', borderRadius: 8, fontSize: 12 }} />
            </RadarChart>
          </ResponsiveContainer>
            ...
            {diseaseScans.map((scan, i) => {
              ...
              return (
                <div key={i} style={{ 
                  ...
                  border: `1px solid ${isClear ? 'rgba(100,116,139,0.15)' : 'rgba(31,41,55,0.2)'}`,
                }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : isTablet ? 'repeat(2, 1fr)' : 'repeat(3, 1fr)', gap: 14 }}>
          {[
            ...
            <div key={r.title} style={{ 
              ...
              border: `1px solid ${r.type === 'alert' ? 'rgba(31,41,55,0.25)' : 'rgba(111,155,134,0.25)'}`,
            }}>
              <div style={{ fontSize: 24, marginBottom: 8 }}>{r.icon}</div>
              <div style={{ fontWeight: 700, fontSize: 13, color: '#1f2937', marginBottom: 2 }}>{r.title}</div>
              <div style={{ fontSize: 11, color: '#64748b', fontWeight: 600, marginBottom: 6 }}>{r.field}</div>
