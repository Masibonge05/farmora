      ...
      <div style={{ maxWidth: 1320, margin: "0 auto" }}>
        <div
          style={{
            ...
            borderRadius: 28,
            padding: 24,
            boxShadow: "0 12px 40px rgba(16, 77, 36, 0.08)",
            marginBottom: 22,
          }}
        >
          <div
            ...
            <div>
              <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 10 }}>
                ...
                <div>
                  ...
                  <div style={{ color: theme.muted, marginTop: 4, fontSize: 14 }}>
                    {ui.subtitle}
                  </div>
                </div>
              </div>
              ...
              <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                <Pill icon={<ShieldCheck size={16} />}>{ui.cropAnalysis}</Pill>
                <Pill icon={<MapPin size={16} />}>{ui.locationAware}</Pill>
                <Pill icon={<Languages size={16} />}>{ui.multilingual}</Pill>
              </div>
              ...
              <div style={{ display: "flex", gap: 8, flexWrap: "wrap", marginTop: 12 }}>
                {fieldLegend.map((fieldItem) => (
                  ...
                  >
                    <span style={{ width: 8, height: 8, borderRadius: 999, background: fieldItem.color }} />
                    {fieldItem.label}
                  </div>
                ))}
              </div>
        ...
        <div
          ...
          style={{
            display: "grid",
            gridTemplateColumns: "0.95fr 1.25fr 0.8fr",
            gap: 22,
            alignItems: "start",
          }}
        >
          <div
            style={{
              ...
              borderRadius: 28,
              padding: 22,
              boxShadow: "0 12px 40px rgba(16, 77, 36, 0.06)",
            }}
          >
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 18 }}>
              <Sparkles size={18} color={theme.greenDark} />
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 18 }}>
              <MessageSquare size={18} color={theme.greenDark} />
              <div style={{ fontWeight: 800, color: theme.text, fontSize: 18 }}>
                {ui.fullChat}
              </div>
            </div>
