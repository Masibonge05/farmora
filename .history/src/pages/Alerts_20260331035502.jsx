...
const typeConfig = {
  alert:   { color: '#111827', bg: 'rgba(31,41,55,0.08)',  border: 'rgba(31,41,55,0.3)',  label: 'Critical', icon: XCircle },
  warning: { color: '#64748b', bg: 'rgba(100,116,139,0.08)', border: 'rgba(100,116,139,0.3)', label: 'Warning',  icon: AlertTriangle },
  info:    { color: '#8fbda8', bg: 'rgba(111,155,134,0.08)', border: 'rgba(111,155,134,0.3)', label: 'Info',     icon: Info },
  success: { color: '#475569', bg: 'rgba(100,116,139,0.08)',  border: 'rgba(100,116,139,0.3)',  label: 'Resolved', icon: CheckCircle },
};
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 24 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <div style={{
              ...
              background: 'rgba(111,155,134,0.18)', border: '1px solid rgba(111,155,134,0.4)',
              display: 'flex', alignItems: 'center', justifyContent: 'center',
            }}>
        ...
        <div style={{
          ...
          background: 'rgba(31,41,55,0.1)', border: '1px solid rgba(31,41,55,0.25)',
        }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 0, marginBottom: 24 }}>
          {[
            ...
            <div key={r.label} style={{
              ...
              padding: '9px 0', borderBottom: '1px solid rgba(100,116,139,0.08)', fontSize: 12,
            }}>
            ...
            <div key={alert.id} style={{
              ...
              <div style={{ flex: 1 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 6 }}>
                  ...
                  <span style={{ fontSize: 11, color: '#334155', whiteSpace: 'nowrap', marginLeft: 10 }}>{alert.time}</span>
                </div>
