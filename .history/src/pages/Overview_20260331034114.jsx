...
export default function Overview({ onNav }) {
  ...
  return (
    <div className="dashboard-frame" style={{ padding: isMobile ? '18px 14px' : '28px 32px', maxWidth: 1200 }}>
      <div className="dashboard-hero" style={{ marginBottom: 22 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 6 }}>
          <span style={{ fontSize: 12, fontWeight: 800, color: 'var(--control-text)', border: '1px solid var(--control-border)', borderRadius: 999, padding: '2px 8px', background: 'var(--control-bg)' }}>OV</span>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : isTablet ? '1fr 1fr' : '1fr 1fr 280px', gap: 20 }}>
                ...
                >
                  <div style={{ display: 'flex', gap: 10, alignItems: 'flex-start' }}>
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <div style={{ fontSize: 10, color: '#334155', marginTop: 6 }}>{alert.time}</div>
                    </div>
                  </div>
                </div>
              );
        ...
        <div>
          ...
          >
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 8, marginTop: 12, paddingTop: 12, borderTop: '1px solid rgba(100,116,139,0.1)' }}>
              {[
            ...
            <div style={{ textAlign: 'center', marginTop: 10, fontSize: 11, color: '#64748b', fontWeight: 600 }}>
          ...
          {weatherData.forecast.map(f => (
            <div key={f.day} className="card" style={{ padding: '10px 14px', marginBottom: 6, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              <div style={{ fontSize: 11, color: '#6f9b86' }}> {f.rain}</div>
          ...
          {marketPrices.map(m => (
            <div key={m.crop} className="card" style={{ padding: '16px 18px' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <span style={{ fontSize: 11, color: '#64748b' }}>{m.buyers} buyers</span>
              </div>
            </div>
          ))}
        </div>
