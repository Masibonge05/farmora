...
const topNavItems = [
  ...
  { id: 'farmora-ai', label: 'AI', icon: Rocket },
];
...
export default function App() {
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', background: 'var(--bg-1)' }}>
      ...
      <main style={{ flex: 1, overflowY: 'auto', position: 'relative', zIndex: 1, paddingTop: '56px' }}>
        <div
          ...
          style={{
            ...
            right: 0,
            zIndex: 100,
            padding: isMobile ? '12px 14px' : '16px 30px',
        ...
        <div className="animate-fade-in" key={activePage} style={{}}>
