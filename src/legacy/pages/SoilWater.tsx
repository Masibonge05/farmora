...
export default function SoilWater() {
  ...
  const soilMetrics = Array.isArray(data?.soilMetrics) ? data.soilMetrics : fallbackSoilMetrics;
  const soilNodes = Array.isArray(data?.soilNodes) ? data.soilNodes : fallbackSoilNodes;
  return (
